...
public class BuilderM extends ClassM {
    ...
    public BuilderM(TypeM aType, TypeM aSuperType, boolean abstractClass, TypeM aProductType, TypeM selfType, boolean isImplementingCopyMethod) {
    ...
    public String toString() {
        return "BuilderM [productType=" + productType + ", properties=" + properties + ", getType()=" + getType() + ", getSuperType()=" + getSuperType() + "]";
    }
