...
public class NewGeneratePojoBuilderProcessor {

	private static final String JAVAX_ANNOTATION_GENERATED = "javax.annotation.Generated";

	private static final Logger LOG = Logger.getLogger(NewGeneratePojoBuilderProcessor.class.getName());

	private ProcessingEnvironment env;
	private BuilderSourceGenerator builderGenerator;
	private BuilderSourceGenerator manualBuilderGenerator;

	public NewGeneratePojoBuilderProcessor(ProcessingEnvironment env) {
		super();
		this.env = env;
