...
public class JavaProject {
     ...
     * 
     * @param workingDirectory will be used to store generated source and class
     *            files
     */
     ...
     * 
     * @param filename the filename mus be relative to the current directory
     *            (that is the directory this JVM has been started from)
     */
