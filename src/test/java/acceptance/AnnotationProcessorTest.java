...
public class AnnotationProcessorTest {
    ...
    public void setupFixture() {
        ...
        prj.getProcessorClasses().add(GeneratePojoBuilderAnnotationProcessor.class);
        // Enable Logging 
    ...
    @Test
    public void compilationOfJavaSourceProducesClassFile()
        throws Exception {
    ...
    @Test
    public void processorCreatesClassForAnnotatedPojo()
        throws Exception {
