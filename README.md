...
you might want to download the [`pojobuilder-4.0.1-jar-with-dependencies.jar`] to get PojoBuilder complete with all dependent libraries included.
...
For example:
    ...
    javac -cp pojobuilder-4.0.1-jar-with-dependencies.jar Contact.java
...
dependencies {
  compile 'net.karneim:pojobuilder:4.0.1'
}
```
...
dependencies {
  codeGeneration 'net.karneim:pojobuilder:4.0.1'
}
...
* Add `pojobuilder-4.0.1-annotations.jar` to your project classpath
...
* Check "Enable project specific settings"
* Click "Add JARs..."
* Add `pojobuiler-4.0.1-jar-with-dependencies.jar`
* Click "OK"
...
[`pojobuilder-4.0.1-jar-with-dependencies.jar`]: https://oss.sonatype.org/content/repositories/releases/net/karneim/pojobuilder/4.0.1/pojobuilder-4.0.1-jar-with-dependencies.jar
