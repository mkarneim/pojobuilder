...
The latest release is [PojoBuilder 2.3.1].
...
For example:
    ...
    javac -cp pojobuilder-2.3.1.jar Contact.java
...
[PojoBuilder 2.3.1]: http://github.com/mkarneim/pojobuilder/raw/master/dist/pojobuilder-2.3.1.zip
