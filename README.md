...
##### `withOptionalProperties=<Class>`
 ...
 `java.util.Optional` introduced with Java 8. Default is `Void.class`, which means, that no
 optional-based setter-methods are generated.
...
* Add `pojobuilder-3.2.0-annotations.jar` to your project classpath
